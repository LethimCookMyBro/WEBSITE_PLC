export const dictionary = {
  ...
  th: {
    ...
    faq1_answer:
      "PANYA ใช้ Retrieval-Augmented Generation (RAG) เพื่อให้คำตอบทั้งหมดอิงจากเอกสารที่ตรวจสอบแล้ว มีความแม่นยำและความเกี่ยวข้องสูงบนมาตรฐาน RAGAs ทุกคำตอบมีการอ้างอิงเพื่อให้คุณสามารถตรวจสอบแหล่งที่มาได้",
